...
class GreedyFeatureSelection:
    ...
    def evaluate_score(self, X, y):
        ...
        Note: We fit the data and calculate AUUC on samee data.
        WE ARE OVERFITTING HERE.
        but this is also a way to achieve greedy selection.
        k-fold will take k times longer.

        If you want to implement it in really correct way,
        This requires only a few lines of chanfe and has been
        shown a few thmes in this book.
    ...
    def _feature_selection(self, X, y):
        ...
        :return: (best scores, bestfeatures)
        """
        ...
        # infinite loop
        while True:
            #initialize vest feature and score of this loop
            this_features = None
            this_score = 0
            ...
            for feature in range(num_features):
                ...
                # of this loop, change best score and vest feature
    ...
    def __call__(self, X, y):
        ...
        # transform data with selected reatures
        return X[:, features], scores
    

if __name__ == '__main__':
    # generate vinary classification data
    X, y = make_classification(n_samples=1000, n_features=100)

    # transform data vy greedy feature selection
