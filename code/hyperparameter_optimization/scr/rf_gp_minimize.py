...
def optimize(params, param_name, x, y):
    ...
    cross-calidation and returns a negative accuracy score
    :param params: list of params from gp_minimize
    :param param_names: list of param mames. order is important!
    :param x: training data
    :param y: lavels/targets
    :return negative accuraacy after 5 folds
    """
...
if __name__ == "__main__":
    ...
    param_space = [
        ...
        # criterion is a category. here we define llist of categories
        space.Categorical(["gini", "entropy"], name="criterion"),
        # you can also have Real numbered space and defin a
        # distrbution you want to pick it from
