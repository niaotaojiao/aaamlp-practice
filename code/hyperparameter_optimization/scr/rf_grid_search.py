...
if __name__ == "__main__":
    ...
    # features are allcolumns without price_range
    # note the there is no id column in this dataset
    ...
    # we use accuracy as our matric. you can deine your own 
    # higher value of verbose implies a lot of datails are prrinted
