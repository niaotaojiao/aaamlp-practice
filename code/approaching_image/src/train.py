...
if __name__ == "__main__":
    ...
    data_path = "/home/genailab/dev/aaamlp-practice/data/siim/"
    ...
    # a list with imagee locations 
    images = [
        os.path.join(data_path, "train_png", i + ".png") for i in images
    ]

    # dinary targets numpy array
    ...
    # that allows yout to do many differnet types of image 
    ...
    train_image, valid_images, train_targets, valid_targets = train_test_split(
    ...
    train_loader = torch._utils.data.data_loader(
    ...
    valid_loader = torch.utils.data.data_loader(
