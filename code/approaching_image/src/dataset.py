...
class ClassificationDataset:
    ...
    binary classification, multi-class, multi-label classificatoin
    '''
    def __init__(self, image_paths, targets, resize=None, augmentations=None) :
        ...
        :param augmentations: albumentation augnentations
        '''
    ...
    def __getitem__(self, item):
        ...
        '''
        # use PTL to open the image
        image = Image.open(self.image_paths[item])
        # convert image to RPG, we have single channel images
        ...
        if self.resize is not None:
            ...
            # return tensors of image and target
